...
import $ from 'jquery';
import QueueDetails from '../../components/semi-components/queue-details.js';
import DetailedQueue from '../../components/semi-components/Queue/detailed_queue.js';
        ...
        pan[i].addEventListener("click", () =>
        {
            ...
            {   
                ...
                //div already exists, remove it, and create another
                {
                    ...
                    rot.render( <DetailedQueue key={`${_data.title}_${i}`} Queue_Status={_data.status} Queue_Description={_data.description}
    ...
    //If they exist remove them, and create new based on the new index value
    {
        ...
        nextPage.addEventListener("click", () =>
        {
            ...
            .done(function( _data) 
            {
                ...
                flushSync(() => 
                { 
                    root.render(_data.map((el, i) => <QueueDetails key={`${el.title}_${i}`} Queue_Updated_At={el.updated_at} Queue_Creation_Date={el.created_at} 
                ...
                .done(function( _data) 
                {
                    ...
                    else 
                    {
                        if(document.querySelector(".pan-main") != null)
                        {
                            ...
                            flushSync(() => 
                            {
                                root.render(_data.map((el, i) => <QueueDetails key={`${el.title}_${i}`} 
                                />))
                            });
