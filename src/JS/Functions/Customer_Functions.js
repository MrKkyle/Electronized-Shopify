...
import $ from 'jquery';
import CustomerDetails from '../../components/semi-components/customer-details.js';
import DetailedCustomer from '../../components/semi-components/Customer/detailed_customer.js';
import DetailedShipping from '../../components/semi-components/Customer/detailed_shipping.js';
        ...
        pan[i].addEventListener("click", () =>
        {
            ...
            {   
                ...
                //div already exists, remove it, and create another
                {
                    ...
                    rot.render( <DetailedCustomer key={`${_data.title}_${i}`} Customer_ID={_data.id}
                    Customer_firstName={_data.first_name} Customer_lastName={_data.last_name} Customer_Phone={_data.phone}
                    Customer_address={_data.addresses.map((el, i) => <DetailedShipping key={`${el.title}_${i}`} 
    ...
    //If they exist remove them, and create new based on the new index value
    {
        ...
        nextPage.addEventListener("click", () =>
        {
            ...
            .done(function( _data) 
            {
                ...
                flushSync(() => 
                { 
                    root.render(_data.map((el, i) => <CustomerDetails key={`${el.title}_${i}`} Customer_ID={el.id}
